...
class TestPyOrgBase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.driver = webdriver.Remote(command_executor = 'http://192.168.100.241:4448/wd/hub', desired_capabilities = chrome_options.to_capabilities())

    def tearDown(self):
        #close on active focus window, quit close all of them.
        self.driver.quit()
